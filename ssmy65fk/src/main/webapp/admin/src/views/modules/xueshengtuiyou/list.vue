		...
		<template v-if="showFlag">
			...
			<!-- <div> -->
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' :sortable='true' prop="tuiyoutupian" width="200" label="推优图片">
						<template slot-scope="scope">
							<div v-if="scope.row.tuiyoutupian">
								<img v-if="scope.row.tuiyoutupian.substring(0,4)=='http'" :src="scope.row.tuiyoutupian.split(',')[0]" width="100" height="100">
								<img v-else :src="$base.url+scope.row.tuiyoutupian.split(',')[0]" width="100" height="100">
							</div>
							<div v-else>无图片</div>
						</template>
					</el-table-column>
