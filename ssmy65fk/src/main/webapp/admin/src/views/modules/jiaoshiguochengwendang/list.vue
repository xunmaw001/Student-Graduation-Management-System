		...
		<template v-if="showFlag">
			...
			<!-- <div> -->
				<el-table class="tables"
					...
					v-if="isAuth('jiaoshiguochengwendang','查看')"
					:data="dataList"
  ...
  methods: {
    ...
    deleteHandler(id) {
      ...
      this.$confirm(`确定进行[${id ? "删除" : "批量删除"}]操作?`, "提示", {
        ...
        this.$http({
          url: "jiaoshiguochengwendang/delete",
          method: "post",
          data: ids
        }).then(({ data }) => {
          if (data && data.code === 0) {
