		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"padding":"0px","margin":"0 0 0 20px","background":"none","display":"flex","width":"100px","justifyContent":"space-between","order":"5"}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"0","borderColor":"#fde2db #fbccc0 #f58c71","margin":"0","textAlign":"center","display":"flex","justifyContent":"center","top":"180px","flexWrap":"wrap","left":"20px","background":"none","borderWidth":"0px","width":"calc(100% - 20px)","position":"absolute","borderStyle":"solid"}' >
					...
					<div :style='{"width":"auto","margin":"0 10px 0 0","background":"none","display":"inline-block"}' class="select" label="就读学校" prop="jiuduxuexiao">
						<label :style='{"padding":"0 4px 0 0","color":"#666","textAlign":"right","display":"inline-block","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">就读学校</label>
						<el-select  @change="jiuduxuexiaoChange" clearable v-model="searchForm.jiuduxuexiao" placeholder="请选择就读学校">
							<el-option v-for="(item,index) in jiuduxuexiaoOptions" v-bind:key="index" :label="item" :value="item"></el-option>
						</el-select>
					</div>
    ...
    getDataList() {
      ...
      let params = {
        ...
        order: 'desc',
           ...
           if(this.searchForm.jiuduxuexiao!='' && this.searchForm.jiuduxuexiao!=undefined){
